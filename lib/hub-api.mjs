        ...
        try {
          ...
          const script = `
            ...
            try {
              ...
              const prompt = 'Analyze this video from ' + fmtTs(startSec) + ' to ' + fmtTs(endSec) + '.\\nFor every camera cut, provide: shotNumber, startTimestamp (MM:SS.s), endTimestamp (MM:SS.s), shotType, subject, action, characterExpressions (object), cameraMovement, tags (array), supercutPotential (array)\\nRULES: Cover EVERY second. Continuous timestamps. Output ONLY a JSON array.';
