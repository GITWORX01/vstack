...
function reanalyzeScene(sceneNum) {
  ...
  modal.innerHTML = '<h3 style="color:#4fc3f7;margin:0 0 16px">\\u{1F504} Tier 1: Re-analyze Scene ' + sceneNum + '</h3>' +
    ...
    '<input id="ra-srt" type="text" placeholder="e.g. C:\\\\Movies\\\\SW-en-full.srt" style="width:100%;padding:6px 8px;background:#0a0a1a;border:1px solid #444;color:#eee;border-radius:4px;font-size:12px;box-sizing:border-box;margin-bottom:12px" />' +
  ...
  modal.querySelector('#ra-go').onclick = function() {
    var srtPath = modal.querySelector('#ra-srt').value.trim();
