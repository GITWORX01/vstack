...
<div class="nav"><a href="/" style="color:#888;text-decoration:none;margin-right:10px;font-size:12px" title="Media Library">◀ Hub</a><span style="color:#4fc3f7;font-weight:bold;margin-right:12px">${EPISODE_ID}</span><label>Jump to: </label><select onchange="document.getElementById('sc-'+this.value)?.scrollIntoView({behavior:'smooth'})">
