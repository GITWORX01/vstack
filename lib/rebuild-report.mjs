...
.shot-scene-wm{position:absolute;top:6px;right:10px;font-size:20px;font-weight:900;color:rgba(255,255,255,0.06);pointer-events:none;z-index:1;text-transform:uppercase;letter-spacing:2px}
